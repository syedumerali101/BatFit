    ...
    render() {
        return (
            <View style={{flex:1, backgroundColor: 'black'}}>
                <ImageBackground style={{height:'100%', opacity: 0.7}} source={require('../images/CrossFits.jpg')}>

                    <HeaderExercise TakeMeBack = {()=> this.props.navigation.goBack()}/>

                    <ExerciseName title='CROSS FITS' YoutubeTutorial = {()=> this.props.navigation.navigate('WebViewArea')}/>
                    ...
                    <ExerciseTerms term='Calories' number='456' explanation1='Burn more if you want to lean' 
                    ...
                    <ButtonStartExercise mainMusic= {require('../music/Theme.mp3')}/>
