    ...
    render() {
        return (
            <View style={{flex:1, backgroundColor: 'black'}}>
                 <ImageBackground style={{height:'100%', opacity: 0.60}} source={require('../images/HammerCurls3.jpg')}>

                    <HeaderExercise TakeMeBack = {()=> this.props.navigation.goBack()}/>

                    <ExerciseName title='HAMMER CURLS' YoutubeTutorial = {()=> this.props.navigation.navigate('WebViewArea')}/>
                    ...
                    <ButtonStartExercise mainMusic= {require('../music/Rocky.mp3')}/>
